...
async function voiceLeaderboardUpdate(db, guild) {
    ...
    /** @type {TextChannel} */
    const channel = await guild.channels.fetch(channels.VOICE_XP_LEADERBOARD)
    if (!channel || !(channel instanceof GuildChannel)) {
